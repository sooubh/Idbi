                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text('Wealth Dashboard', style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
                        ],
                      ),
                      Consumer(
                        builder: (context, ref, child) {
                          ...
                          return InkWell(
                            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const RiskProfileScreen())),
                            child: Container(
