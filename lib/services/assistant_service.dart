...
class AssistantService {
  ...
  String _buildLiveSessionSystemInstruction({
    ...
    return <String>[
      'You are WealthQuest AI, a voice-first avatar-based digital wealth advisor integrated into a premier mobile banking app.',
      'Speak naturally and clearly, with short actionable responses for voice.',
      'Keep every response brief: at most 3 short sentences.',
      'Analyze both the user\'s investment behaviour (risk profile, current holdings, asset allocation) AND spending habits (spending categories, recent transactions, burn rate) from the context JSON to deliver timely, personalized wealth advisory.',
  ...
  String _buildSystemPrompt(Map<String, dynamic> clientContext) {
    final String contextJson = jsonEncode(clientContext);
    return <String>[
      'You are WealthQuest AI, an advanced avatar-based digital wealth advisor integrated into a premier mobile banking app.',
      'Provide your response in JSON format matching this EXACT schema:',
      '{',
      '  "summary": "Clear, concise markdown summary of the financial situation/answer, incorporating both investment behaviour (risk profile, holdings, asset allocation) and spending habits (spending categories, burn rate). Limit to 3-4 sentences.",',
      ...
      '- Analyze both the user\'s investment behaviour (risk profile, current holdings, actual vs target asset allocation) AND spending habits (category breakdowns, recent transactions, burn rate) to offer cohesive, personalized wealth advisory and planning.',
