...
final defaultAssistantPromptsProvider = Provider<List<String>>((ref) {
  return const <String>[
    ...
    'What is the best investment portfolio for my risk profile?',
  ];
});
...
final assistantClientContextProvider = Provider<Map<String, dynamic>>((ref) {
  ...
  final List<InvestmentHolding> investments =
      ref.watch(investmentsProvider).value ?? const <InvestmentHolding>[];
  final riskProfile = ref.watch(riskProfileProvider);
  ...
  final List<Map<String, dynamic>> investmentSummary = investments
      .map((InvestmentHolding holding) {
        return <String, dynamic>{
          'name': holding.name,
  ...
  return <String, dynamic>{
    'dashboard': <String, dynamic>{
      ...
      'totalInvested': snapshot.totalInvestments,
    ...
    'riskProfile': <String, dynamic>{
      'classification': riskProfile.name,
      'description': riskProfile.description,
      'targetAllocation': riskProfile.targetAllocation,
    },
